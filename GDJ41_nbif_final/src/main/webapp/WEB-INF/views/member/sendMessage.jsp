...
<body style="margin:0;">
	<div id="btn-contaier">
		<button class="msgBoxBtn" onclick="pageMove(this.value);" value="receiv">받은쪽찌함</button>
		<button class="msgBoxBtn" onclick="pageMove(this.value);" value="send">보낸쪽찌함</button>
